...
?>
<!-- Home Section Start -->
<div class="home-section home-section-demo mb-5">

    <div id="owl-demo" class="slider owl-carousel owl-theme ">

        <div class="item ">
            <div class="row">
                <div class="col-md-12">
                    <div class="gif" style="transform:rotate(180deg);">
                        <img src="assets/img/bugs/bug-gif3.gif"  class="img-fluid" alt="">
                    </div>
                </div>
        ...
        <div class="item">
            <div class="row">
                <div class="col-md-12">
                    <div class="gif">
                        <img src="assets/img/bugs/bug-gif2.gif"  alt="">
                    </div>
                </div>
        ...
        <!-- <div class="item">
            <div class="row">
                <div class="col-md-12">
                    <div class="gif">
                        <img src="assets/img/bugs/bug-gif1.gif"  alt="">
                    </div>
                </div>
...
<section class="py-5 abstract mb-5" style="background-color: rgb(25,5,102);">
    <div class="container text-center">
        ...
        <div class=" row circle-row owlCarousel ">
            ...
            <div class="col-lg-3  col-sm-4 col-xs-6 my-4 container-box2">
                <div class="circle ">
                    <div class="inner">
                        <span>Ants</span>
                    </div>
        ...
        <div class="row ">
            <div class="serviceslider owl-carousel ">
                ...
                <div class="">
                    <div class="service-item">
                        <i class="flaticon-medal"></i>
                        <h3>Viral Disinfection Services</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do contratc.</p>
